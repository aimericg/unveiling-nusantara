...
const strings = ["ARE TYPEFACES TO CHANGE FUNCTION IN A FOREIGN ENVIRONMENT?", "CAN TYPEFACES BE READAPTED IN A FOREIGN ENVIRONMENT?","CAN TYPEFACES CHANGE POSITIONALITY WHEN BEING USED VERNACULARLY?"];
